...
; section notes:
;
; Data section is used for declaring initalize data or constants. this data does change at runtime. You can declare various constant values, file names, or buffer size. 
